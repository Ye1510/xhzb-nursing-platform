...
public class ReservationController extends BaseController
{
    ...
    public AjaxResult getInfo(@Schema(name = "预约ID", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    {
        reservation.setCreateBy(String.valueOf(SecurityUtils.getUserId()));
    ...
    {
        reservation.setUpdateBy(String.valueOf(SecurityUtils.getUserId()));
    ...
    public AjaxResult remove(@Schema(name = "预约ID", requiredMode = Schema.RequiredMode.REQUIRED) @PathVariable Long[] ids)
    {
