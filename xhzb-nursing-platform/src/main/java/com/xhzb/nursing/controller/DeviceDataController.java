...
public class DeviceDataController extends BaseController
{
    ...
    @Log(title = "设备上报数据", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @Operation(summary = "导出设备上报数据列表")
    public void export(HttpServletResponse response, DeviceData deviceData)
    {
        ...
        util.exportExcel(response, list, "设备上报数据数据");
    }
    ...
    @GetMapping(value = "/{id}")
    @Operation(summary = "获取设备上报数据详细信息")
    public AjaxResult getInfo(@Schema(name = "设备上报数据ID", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Log(title = "设备上报数据", businessType = BusinessType.INSERT)
    @PostMapping
    @Operation(summary = "新增设备上报数据")
    ...
    @Log(title = "设备上报数据", businessType = BusinessType.UPDATE)
    @PutMapping
    @Operation(summary = "修改设备上报数据")
    ...
    @Log(title = "设备上报数据", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
    @Operation(summary = "删除设备上报数据")
    public AjaxResult remove(@Schema(name = "设备上报数据ID", requiredMode = Schema.RequiredMode.REQUIRED) @PathVariable Long[] ids)
    {
